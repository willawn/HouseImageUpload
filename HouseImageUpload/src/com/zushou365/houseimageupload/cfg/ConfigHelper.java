...
public final class ConfigHelper {
	...
	//cur application path
	public static final String locateApplicationPath() {
		String cfgpath = locateConfigPath(ImageConfiguration.configFilePath);
		String applicationPath = StringUtil.replace(cfgpath,"WEB-INF/classes"+ImageConfiguration.configFilePath,"");
