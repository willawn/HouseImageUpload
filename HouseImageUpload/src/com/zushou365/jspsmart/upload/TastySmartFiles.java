...
public class TastySmartFiles
{
    ...
    protected void addFile(TastySmartFile file)
    {
        if(file == null)
        {
    ...
    public TastySmartFile getFile(int i)
    {
        if(i < 0)
        {
            throw new IllegalArgumentException("File's index cannot be a negative value (1210).");
        }
        TastySmartFile file = (TastySmartFile)m_files.get(new Integer(i));
        if(file == null)
        {
